...
namespace ExpenseTracker.Controllers
{
    ...
    public class ClothingController : ControllerBase
    {
        ...
        /// <summary>
        /// Actualiza un gasto de ropa existente.
        /// </summary>
        [HttpPut("{id}")]
        ...
        /// <summary>
        /// Elimina un gasto de ropa por su ID.
        /// </summary>
        [HttpDelete("{id}")]
        ...
        /// <summary>
        /// Obtiene un gasto de ropa por su ID.
        /// </summary>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Lista paginada de gastos de ropa con filtros.
        /// 
        ...
        /// 
        /// También se puede usar un rango personalizado con startDate y endDate.
        /// </summary>
        [HttpGet]
        ...
        {
            // Resolver rango de fechas según el período
